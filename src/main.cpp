...
unsigned int nStakeMaxAge = 60 * 60 * 4;	// stake age of full weight: 30d
unsigned int nStakeTargetSpacing = 60;			// 30 sec block spacing

int64 nChainStartTime = 1394303125;
...
const string strMessageMagic = "UNUM Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    int64 nSubsidy = 50 * COIN;
        if(nHeight<2) { //2 days bonus for early adopters
...
static const int64 nTargetTimespan = 60 * 10;  // 4 hours
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in UNUM
    bool fStrictPayToScriptHash = true; // Always active in UNUM
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "UNUM", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "UNUMdd2EEEsdddd22MADEBYCFPROBLEMLA";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1391713325;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 3004230;
...
//        printf("block.nNonce = %u \n", block.nNonce);
        ...
        assert(block.hashMerkleRoot == uint256("0xa767715673554eecb5653a47da6d064485b1c8287d944a92ed65da268e9fbf28"));
